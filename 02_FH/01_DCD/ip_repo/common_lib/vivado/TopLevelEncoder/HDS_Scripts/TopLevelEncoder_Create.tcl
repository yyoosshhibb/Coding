...
set xilinxProject "./TopLevelEncoder.xpr"
set library common_lib
set unit TopLevelEncoder
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/TopLevelEncoder_fileList.tcl"
set hdlFileList ./HDS_Scripts/TopLevelEncoder_fileList.tcl
