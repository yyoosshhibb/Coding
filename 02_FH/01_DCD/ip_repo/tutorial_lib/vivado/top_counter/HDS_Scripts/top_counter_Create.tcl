...
set xilinxProject "./top_counter.xpr"
set library tutorial_lib
set unit top_counter
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/top_counter_fileList.tcl"
set hdlFileList ./HDS_Scripts/top_counter_fileList.tcl
