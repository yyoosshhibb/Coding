...
set xilinxProject "./connectionEncoderLEDs.xpr"
set library common_lib
set unit connectionEncoderLEDs
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/connectionEncoderLEDs_fileList.tcl"
set hdlFileList ./HDS_Scripts/connectionEncoderLEDs_fileList.tcl
