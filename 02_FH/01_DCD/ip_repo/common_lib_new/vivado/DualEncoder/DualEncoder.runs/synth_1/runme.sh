...
HD_PWD='C:/Users/Yoshi/Documents/FH/02_Master/01_DCD/ip_repo/common_lib_new/vivado/DualEncoder/DualEncoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DualEncoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DualEncoder.tcl
