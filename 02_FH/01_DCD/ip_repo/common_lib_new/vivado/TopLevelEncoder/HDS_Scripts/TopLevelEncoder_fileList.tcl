...
lappend hdsFileList common_lib
lappend hdsFileList "$::env(HDS_PROJECT_DIR)/common_lib/hdl/toplevelencoder_struct.vhd"
set hdsFileDialectsArray("$::env(HDS_PROJECT_DIR)/common_lib/hdl/toplevelencoder_struct.vhd") "VHDL_2008"
