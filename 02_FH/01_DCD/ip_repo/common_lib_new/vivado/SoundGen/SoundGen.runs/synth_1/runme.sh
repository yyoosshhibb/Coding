...
HD_PWD='C:/Users/Yoshi/Documents/FH/02_Master/01_DCD/ip_repo/common_lib_new/vivado/SoundGen/SoundGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoundGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoundGen.tcl
