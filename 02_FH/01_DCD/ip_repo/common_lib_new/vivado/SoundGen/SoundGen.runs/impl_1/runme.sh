...
HD_PWD='C:/Users/Yoshi/Documents/FH/02_Master/01_DCD/ip_repo/common_lib_new/vivado/SoundGen/SoundGen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SoundGen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SoundGen.tcl -notrace
