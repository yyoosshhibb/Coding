...
#set_property IOSTANDARD LVCMOS33 [get_ports MAVLINK_rxd]
#set_property IOSTANDARD LVCMOS33 [get_ports MAVLINK_txd]
#set_property PACKAGE_PIN V12 [get_ports MAVLINK_rxd]
#set_property PACKAGE_PIN W16 [get_ports MAVLINK_txd]
...
set_false_path -from [get_pins design_1_i/MIPI_2_Video_in/csi_to_axis_0/U0/lane_align_inst/err_req_reg/C] -to [get_pins design_1_i/MIPI_2_Video_in/csi2_d_phy_rx_0/U0/clock_upd_req_reg/D]
...
set_property OFFCHIP_TERM NONE [get_ports hdmi_clk_n]
set_property IOSTANDARD TMDS_33 [get_ports hdmi_clk_n]

set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pmod_1[0]}]
set_property PACKAGE_PIN N15 [get_ports {pmod_0[0]}]
set_property PACKAGE_PIN L14 [get_ports {pmod_0[1]}]
set_property PACKAGE_PIN K16 [get_ports {pmod_0[2]}]
set_property PACKAGE_PIN K14 [get_ports {pmod_0[3]}]
set_property PACKAGE_PIN N16 [get_ports {pmod_0[4]}]
set_property PACKAGE_PIN L15 [get_ports {pmod_0[5]}]
set_property PACKAGE_PIN J16 [get_ports {pmod_0[6]}]
set_property PACKAGE_PIN J14 [get_ports {pmod_0[7]}]
set_property PACKAGE_PIN V12 [get_ports {pmod_1[0]}]
set_property PACKAGE_PIN W16 [get_ports {pmod_1[1]}]
set_property PACKAGE_PIN J15 [get_ports {pmod_1[2]}]
set_property PACKAGE_PIN H15 [get_ports {pmod_1[3]}]
set_property PACKAGE_PIN V13 [get_ports {pmod_1[4]}]
set_property PACKAGE_PIN U17 [get_ports {pmod_1[5]}]
set_property PACKAGE_PIN T17 [get_ports {pmod_1[6]}]
set_property PACKAGE_PIN Y17 [get_ports {pmod_1[7]}]

set_property IOSTANDARD LVCMOS33 [get_ports {uart_txd_0}]
set_property PACKAGE_PIN W15 [get_ports {uart_txd_0}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart_rxd_0}]
set_property PACKAGE_PIN T11 [get_ports {uart_rxd_0}]
