...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="AudioFilter_Callback_BF706Mini_19_FFT" -proc ADSP-BF706 -si-revision any -g -D_DEBUG -DCORE0 @includes-d1c780da07f985e20599f28b689a7aa9.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
