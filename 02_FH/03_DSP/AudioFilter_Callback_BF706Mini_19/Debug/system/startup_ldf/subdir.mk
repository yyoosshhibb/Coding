...
system/startup_ldf/app_cplbtab.doj: ../system/startup_ldf/app_cplbtab.c
	...
	ccblkfn -c -file-attr ProjectName="AudioFilter_Callback_BF706Mini_19" -proc ADSP-BF706 -flags-compiler --no_wrap_diagnostics -si-revision any -g -D_DEBUG -DADI_DEBUG -DNO_UTILITY_ROM -DCORE0 @includes-fd0b2f45984a9b6c42b6a0cf9cac851a.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -decls-strong -cplbs -no-utility-rom -gnu-style-dependencies -MD -Mo "system/startup_ldf/app_cplbtab.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="AudioFilter_Callback_BF706Mini_19" -proc ADSP-BF706 -si-revision any -g -D_DEBUG -DCORE0 @includes-95a1ded3488c676a9220956fb710ac0b.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
