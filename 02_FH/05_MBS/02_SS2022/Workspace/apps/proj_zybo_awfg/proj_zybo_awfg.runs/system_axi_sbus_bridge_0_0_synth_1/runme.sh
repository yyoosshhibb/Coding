...
HD_PWD='D:/_Projekte/Alfreda/Workspace/apps/proj_zybo_awfg/proj_zybo_awfg.runs/system_axi_sbus_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_sbus_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_sbus_bridge_0_0.tcl
