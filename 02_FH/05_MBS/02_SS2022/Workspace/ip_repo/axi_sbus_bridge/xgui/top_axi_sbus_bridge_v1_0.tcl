...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_CORE_CLOCK_FREQ" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "hw_serial_number_g" -parent ${Page_0}
  ipgui::add_param $IPINST -name "hw_version_g" -parent ${Page_0}


}

proc update_PARAM_VALUE.C_CORE_CLOCK_FREQ { PARAM_VALUE.C_CORE_CLOCK_FREQ } {
	# Procedure called to update C_CORE_CLOCK_FREQ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_CORE_CLOCK_FREQ { PARAM_VALUE.C_CORE_CLOCK_FREQ } {
	# Procedure called to validate C_CORE_CLOCK_FREQ
	return true
}
...
proc update_PARAM_VALUE.hw_serial_number_g { PARAM_VALUE.hw_serial_number_g } {
	# Procedure called to update hw_serial_number_g when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.hw_serial_number_g { PARAM_VALUE.hw_serial_number_g } {
	# Procedure called to validate hw_serial_number_g
	return true
}

proc update_PARAM_VALUE.hw_version_g { PARAM_VALUE.hw_version_g } {
	# Procedure called to update hw_version_g when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.hw_version_g { PARAM_VALUE.hw_version_g } {
	# Procedure called to validate hw_version_g
	return true
}
...
proc update_MODELPARAM_VALUE.C_CORE_CLOCK_FREQ { MODELPARAM_VALUE.C_CORE_CLOCK_FREQ PARAM_VALUE.C_CORE_CLOCK_FREQ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_CORE_CLOCK_FREQ}] ${MODELPARAM_VALUE.C_CORE_CLOCK_FREQ}
}

proc update_MODELPARAM_VALUE.hw_serial_number_g { MODELPARAM_VALUE.hw_serial_number_g PARAM_VALUE.hw_serial_number_g } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.hw_serial_number_g}] ${MODELPARAM_VALUE.hw_serial_number_g}
}

proc update_MODELPARAM_VALUE.hw_version_g { MODELPARAM_VALUE.hw_version_g PARAM_VALUE.hw_version_g } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.hw_version_g}] ${MODELPARAM_VALUE.hw_version_g}
}
