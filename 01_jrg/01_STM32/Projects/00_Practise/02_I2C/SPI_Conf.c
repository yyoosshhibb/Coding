...
//Initialize CS Pins in GPIO management!
...
void SPI_Init(void)
{
	...
	//General Parameters for SPI Initialization
  ...
  if (HAL_SPI_Init(&hspi1) != HAL_OK)
  {
    Error_Handler();
		...
		osThreadFlagsSet(id_Task_LED01, FLAG_SPI1_CONFIG_READY);
		osThreadFlagsSet(id_Task_LED02, FLAG_SPI1_CONFIG_READY);
		osThreadFlagsSet(id_Task_LED03, FLAG_SPI1_CONFIG_READY);
		osThreadFlagsSet(id_Task_LED04, FLAG_SPI1_CONFIG_READY);
