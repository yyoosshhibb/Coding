...
typedef struct{		
	...
	uint8_t				configByte;	//Confguration for how to read
}SPI_RX_MSG_t;

#define FLAG_SPI1_CONFIG_READY 0x09

//define SPI Pins and Flags
#if USE_SPI1
...
/************If you change the Ports from A/B/C for SPI1/2/3 change it in the init function***********/

#if USE_SPI2
	#define FLAG_SPI2_CONFIG_READY		0x0A
...
#if USE_SPI3
	#define FLAG_SPI3_CONFIG_READY		0x0B
