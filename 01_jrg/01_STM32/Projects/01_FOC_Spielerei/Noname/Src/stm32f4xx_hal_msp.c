...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = M1_BUS_VOLTAGE_Pin|M1_CURR_AMPL_U_Pin|M1_TEMPERATURE_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOA, M1_BUS_VOLTAGE_Pin|M1_CURR_AMPL_U_Pin|M1_TEMPERATURE_Pin);
