...
#endif
#ifdef HW_R5_ELB
TR_t TR_Water_Fan_R5;

uint8_t Brushless_PWM;
#endif
#if USE_WATER_SPLASH
TR_t TR_Water_Splash;
#endif

#ifdef HW_ELB
osThreadId_t id_task_TR1;
osThreadId_t id_task_TR2;
osThreadId_t id_task_TR3;
#endif
#ifdef HW_R5_ELB
...
//////////////////////////////////////////////////////////////////////////////////////////	
	...
	osThreadFlagsSet(id_task_TR1,FLAG_TR_CONFIG_READY);
	osThreadFlagsSet(id_task_TR2,FLAG_TR_CONFIG_READY);
	osThreadFlagsSet(id_task_TR3,FLAG_TR_CONFIG_READY);
#endif
