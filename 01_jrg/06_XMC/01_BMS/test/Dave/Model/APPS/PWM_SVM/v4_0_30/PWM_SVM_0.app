...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_SVM" URI="http://resources/4.0.30/app/PWM_SVM/0" description="Generates 3-phase space vector pulse width modulated &#xA;outputs using CCU8. It supports symmetric &#xA; 7-segment/5-segment SVM algorithm." mode="NOTSHARABLE" version="4.0.30" minDaveVersion="4.0.0" instanceLabel="PWM_SVM_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_ph_u_compare_match_up/down" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_cmds_cmus_cmpch1_phu" hwResource="//@hwResources.0" visible="true" solverVariableName="sv0" solverVariableValue="cmd2s_cmu2s"/>
  <virtualSignals name="event_ph_v_compare_match_up/down" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_cmds_cmus_cmpch1_phv" hwResource="//@hwResources.1" visible="true" solverVariableName="sv1" solverVariableValue="cmd2s_cmu2s"/>
  <virtualSignals name="event_ph_w_compare_match_up/down" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_cmds_cmus_cmpch1_phw" hwResource="//@hwResources.2" visible="true" solverVariableName="sv2" solverVariableValue="cmd2s_cmu2s"/>
  ...
  <virtualSignals name="ph_u_ch_status" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_sta_phu" hwResource="//@hwResources.0" visible="true" solverVariableName="sv3" solverVariableValue="stb"/>
  <virtualSignals name="ph_v_ch_status" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_sta_phv" hwResource="//@hwResources.1" visible="true" solverVariableName="sv4" solverVariableValue="stb"/>
  <virtualSignals name="ph_w_ch_status" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_sta_phw" hwResource="//@hwResources.2" visible="true" solverVariableName="sv5" solverVariableValue="stb"/>
  ...
  <virtualSignals name="ph_u_high" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out0_phu" hwResource="//@hwResources.0" solverVariableName="sv6" solverVariableValue="out2"/>
  <virtualSignals name="ph_v_high" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out0_phv" hwResource="//@hwResources.1" solverVariableName="sv7" solverVariableValue="out2"/>
  <virtualSignals name="ph_w_high" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out0_phw" hwResource="//@hwResources.2" solverVariableName="sv8" solverVariableValue="out2"/>
  ...
  <virtualSignals name="ph_u_low" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out1_phu" hwResource="//@hwResources.0" solverVariableName="sv9" solverVariableValue="out3"/>
  <virtualSignals name="ph_v_low" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out1_phv" hwResource="//@hwResources.1" solverVariableName="sv10" solverVariableValue="out3"/>
  <virtualSignals name="ph_w_low" URI="http://resources/4.0.30/app/PWM_SVM/0/vs_pwm_svm_out1_phw" hwResource="//@hwResources.2" solverVariableName="sv11" solverVariableValue="out3"/>
