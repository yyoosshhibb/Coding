...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="ADC_QUEUE" URI="http://resources/4.0.22/app/ADC_QUEUE/0" description="Provides configurations for queue request source of VADC" mode="NOTSHARABLE" version="4.0.22" minDaveVersion="4.0.0" instanceLabel="ADC_QUEUE_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="queue_select" URI="http://resources/4.0.22/app/ADC_QUEUE/0/vs_adc_queue_queue2channel" hwSignal="select" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PMSM_FOC/v4_2_14/PMSM_FOC_0.app#//@connections.10"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PMSM_FOC/v4_2_14/PMSM_FOC_0.app#//@connections.11"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PMSM_FOC/v4_2_14/PMSM_FOC_0.app#//@connections.12"/>
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PMSM_FOC/v4_2_14/PMSM_FOC_0.app#//@connections.14"/>
  </virtualSignals>
