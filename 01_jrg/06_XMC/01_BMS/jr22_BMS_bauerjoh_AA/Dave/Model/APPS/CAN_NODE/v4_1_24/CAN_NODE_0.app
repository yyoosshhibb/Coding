...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAN_NODE" URI="http://resources/4.1.24/app/CAN_NODE/0" description="The CAN_NODE APP configures a node and MO registers &#xA;of MultiCAN module. &#xA;It provides run-time functions to change the node baud rate &#xA;and to enable/disable node and MO events." mode="NOTSHARABLE" version="4.1.24" minDaveVersion="4.0.0" instanceLabel="CAN_NODE_0" appLabel="">
  ...
  <virtualSignals name="event_node_transfer_ok" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_can_trinp" hwSignal="trinp" hwResource="//@hwResources.2" visible="true"/>
  ...
  <hwResources name="CAN Receive Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_rx" resourceGroupUri="devicepackage/0/70" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.20"/>
  </hwResources>
  <hwResources name="CAN Transmit Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_tx" resourceGroupUri="devicepackage/0/71" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
