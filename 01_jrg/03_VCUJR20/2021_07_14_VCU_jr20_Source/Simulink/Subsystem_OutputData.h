...
#ifndef RTW_HEADER_Subsystem_OutputData_h_
#define RTW_HEADER_Subsystem_OutputData_h_
#include <math.h>
...
extern void FUNC_OutputData(void);

#endif                                 /* RTW_HEADER_Subsystem_OutputData_h_ */
