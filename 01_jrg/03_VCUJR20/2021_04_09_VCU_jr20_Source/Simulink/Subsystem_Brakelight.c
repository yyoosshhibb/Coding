 ...
 */
/*@>c6e0*/VCU_B./*@>c876*/RelationalOperator_c/*@>6a7a*/ = (/*@>c6e6*/VCU_B./*@>c879*/Add1_m/*@>6a79*/ > /*@>c464*/15.0);
/* RelationalOperator: '<S1>/Relational Operator1' incorporates:
 *  Constant: '<S1>/Constant'
 */
/*@>c6ec*/VCU_B./*@>c87c*/RelationalOperator1_b/*@>6a7e*/ = (/*@>c465*/15.0/*@>6a7d*/ < /*@>c6f2*/VCU_B./*@>c87f*/Sensitivity1538mVbar);
